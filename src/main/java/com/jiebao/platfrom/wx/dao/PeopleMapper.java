...
public interface PeopleMapper extends BaseMapper<People> {
    ...
    @Select("select hl_id as hlId,shi as shi,qu_xian as quXian,xiang as xiang,(select dept_name from sys_dept where dept_id=w.shi) as shiName, (select dept_name from sys_dept where dept_id=w.qu_xian) " +
            "  as  quXianName,(select dept_name from sys_dept where dept_id=w.xiang)   as xiangName,proper ,line,name,sex,age,face,address,id_card as idCard,lu_duan as" +
    ...
    @Select("select hl_id as hlId,shi as shi,qu_xian as quXian,xiang as xiang,(select dept_name from sys_dept where dept_id=w.shi) as shiName, (select dept_name from sys_dept where dept_id=w.qu_xian) " +
            "  as  quXianName,(select dept_name from sys_dept where dept_id=w.xiang)   as xiangName,proper ,line,(select field_name from sys_dict_new where dict_id=w.line) as lineName,name,sex,age,face,address,id_card as idCard,lu_duan as" +
            " luDuan,phone,is_wx isWx,is_qun as isQun,police from wx_people w ${ew.customSqlSegment}")
